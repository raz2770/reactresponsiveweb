...
export declare function isInProperties(roles: IObject<any>, args: NameType[], isCheckTrue?: boolean): boolean;
export declare function isRole(args: NameType[], isCheckTrue?: boolean): boolean;
